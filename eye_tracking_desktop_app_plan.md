...
|-------|----------|----------|--------|
| **Phase 1: MVP** | Weeks 1-3 | Eye detection, gaze tracking, mouse control, calibration | 🔴 |
| **Phase 2: Enhancement** | Weeks 4-5 | Settings, visual feedback, multi-monitor support | 🔴 |
